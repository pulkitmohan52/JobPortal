...
const Signup = () => {
  ...
  const validateEmail = () => {
    return (
      email.includes("@") && (email.includes("in") || email.includes("com"))
    );
  };

  const validatePhoneNumber = () => {
    const phoneNumberRule = /^[0-9]+$/;
    return phoneNumberRule.test(phoneNumber) && phoneNumber.length === 10;
  };
  ...
  useEffect(() => {
    ...
    const newTimeoutId = setTimeout(() => {
      ...
      if (phoneNumber && !validatePhoneNumber()) {
        newErrors[phoneNumber] = "Incorrect phone number format.";
      }

      if (password && !validatePassword()) {
        newErrors[password] = "Please enter password correctly!";
      }
            ...
            <div className="border border-gray-300 rounded-lg p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
              <form className="space-y-4">
                ...
                <div>
                  ...
                  {errors[email] && (
                    <p className="ml-1 text-red-500">{errors[email]}</p>
                  )}
                </div>
                <div>
                  <label
                  ...
                  {errors[phoneNumber] && (
                    <p className="ml-1 text-red-500">{errors[phoneNumber]}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors[password] && (
                    <p className="ml-1 text-red-500">{errors[password]}</p>
                  )}
                </div>
